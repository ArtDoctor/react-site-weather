...
export default function App() {
  ...
  function Login(details: { email: string; password: string; name: string; }) {
    console.log(details);
      ...
      <header className = "header">
        <nav className = "navbar">
            ...
            <ul className = "navoptions">
                ...
                {/* <li className = "navoption"><Link to="/sign-up">Sign up</Link></li> */}
                {user.email==""&&
        ...
        {user.email!=""&&
          <div className="additional">
            <p className="user">Welcome, <span>{user.name}</span></p> 
...
function Forecast(LoggedIn: any) {
  const [user, setUser] = useState({name: "", email: ""});
